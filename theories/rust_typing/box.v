...
Section rules.
  ...
  Proof.
    iIntros "HR" (Φ F ??). iIntros "#(LFT & TIME & LLCTX) #HE HL Hna Hincl0 HP HΦ/=".
    ...
    iApply ("HR" with "[//] [//] [$LFT $TIME $LLCTX] HE HL Hna [] Hb"). { destruct bmin0; done. }
  ...
  Proof.
    ...
    iExists l'.
    iSplitR. { iPureIntro. unfold mem_cast. rewrite val_to_of_loc. done. }
    iApply ("HT" with "[//] [//] [$LFT $TIME $LLCTX] HE HL Hna [] Hb"). { destruct bmin0; done. }
    iModIntro. iIntros (L'' κs' l2 b2 bmin rti tyli ri strong weak) "#Hincl1 Hb Hs".
