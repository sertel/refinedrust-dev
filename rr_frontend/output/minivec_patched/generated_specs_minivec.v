...
Section RawVec_ty.
  ...
  Definition RawVec_ty : type (plist place_rfn [loc : Type; Z : Type; unit : Type]) := struct_t (RawVec_sls (ty_syn_type T_ty)) +[alias_ptr_t; (int USize); unit_t].
  Definition RawVec_rt : Type.
  Proof using T_rt. let __a := eval hnf in (rt_of RawVec_ty) in exact __a. Defined.
  Global Typeclasses Transparent RawVec_ty.
  Global Typeclasses Transparent RawVec_rt.
End RawVec_ty.
Global Arguments RawVec_rt : clear implicits.
...
Section RawVec_inv_t.
  ...
  Program Definition RawVec_inv_t_inv_spec : ex_inv_def ((RawVec_rt T_rt)) ((loc * nat)) := mk_ex_inv_def
  ...
  Global Typeclasses Transparent RawVec_inv_t.
  Definition RawVec_inv_t_rt : Type.
  Proof using T_rt. let __a := eval hnf in (rt_of RawVec_inv_t) in exact __a. Defined.
  Global Typeclasses Transparent RawVec_inv_t_rt.
End RawVec_inv_t.
Global Arguments RawVec_inv_t_rt : clear implicits.
...
Section Vec_ty.
  ...
  Definition Vec_ty : type (plist place_rfn [(RawVec_inv_t_rt T_rt) : Type; Z : Type]) := struct_t (Vec_sls (ty_syn_type T_ty)) +[(RawVec_inv_t (T_ty)); (int USize)].
  Definition Vec_rt : Type.
  Proof using T_rt. let __a := eval hnf in (rt_of Vec_ty) in exact __a. Defined.
  Global Typeclasses Transparent Vec_ty.
  Global Typeclasses Transparent Vec_rt.
End Vec_ty.
Global Arguments Vec_rt : clear implicits.
...
Section Vec_inv_t.
  ...
  Global Typeclasses Transparent Vec_inv_t.
  Definition Vec_inv_t_rt : Type.
  Proof using T_rt. let __a := eval hnf in (rt_of Vec_inv_t) in exact __a. Defined.
  Global Typeclasses Transparent Vec_inv_t_rt.
...
End Vec_inv_t.
Global Arguments Vec_inv_t_rt : clear implicits.
...
Section std_option_Option_ty.
  ...
  Definition std_option_Option_None_rt : Type.
  Proof using . let __a := eval hnf in (rt_of std_option_Option_None_ty) in exact __a. Defined.
  Global Typeclasses Transparent std_option_Option_None_ty.
  Global Typeclasses Transparent std_option_Option_None_rt.

  Definition std_option_Option_Some_ty : type (plist place_rfn [T_rt : Type]) := struct_t (std_option_Option_Some_sls (ty_syn_type T_ty)) +[T_ty].
  Definition std_option_Option_Some_rt : Type.
  Proof using T_rt. let __a := eval hnf in (rt_of std_option_Option_Some_ty) in exact __a. Defined.
  Global Typeclasses Transparent std_option_Option_Some_ty.
  Global Typeclasses Transparent std_option_Option_Some_rt.
  ...
  Definition std_option_Option_ty_rt : Type.
  Proof using T_rt. let __a := eval hnf in (rt_of std_option_Option_ty) in exact __a. Defined.
  Global Typeclasses Transparent std_option_Option_ty.
  Global Typeclasses Transparent std_option_Option_ty_rt.

  Global Program Instance construct_enum_None  : ConstructEnum std_option_Option_enum "None" (struct_t std_option_Option_None_sls +[]) -[] None := construct_enum _ _.
  Next Obligation. intros; unfold TCDone in *; naive_solver. Qed.
  Global Program Instance construct_enum_Some x T_st `{!TCDone (T_st = ty_syn_type T_ty)} : ConstructEnum std_option_Option_enum "Some" (struct_t (std_option_Option_Some_sls T_st) +[T_ty]) -[x] (Some x) := construct_enum _ _.
  Next Obligation. intros; unfold TCDone in *; naive_solver. Qed.
End std_option_Option_ty.
Global Arguments std_option_Option_ty_rt : clear implicits.
