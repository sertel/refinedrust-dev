...
pub fn dump_borrowck_info<'a, 'tcx>(env: &'a Environment<'tcx>, procedure: &ProcedureDefId, info: &'a PoloniusInfo<'a, 'tcx>) {
    trace!("[dump_borrowck_info] enter");
...
impl<'a, 'tcx: 'a> InfoPrinter<'a, 'tcx> {
    fn dump_borrowck_facts(&self, info: &'a PoloniusInfo<'a, 'tcx>, writer: &mut BufWriter<File>) -> std::io::Result<()> {
